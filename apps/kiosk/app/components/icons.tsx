  ...
  return (
    ...
    >
      <svg width={size * 0.75} height={size * 0.75} viewBox="0 0 12 12" fill="none">
        <path d="M6 2V10M2 6H10" stroke="#0A0E0C" strokeWidth="2" strokeLinecap="round" />
      </svg>
    </div>
  );
}

export function Mic({ size = 20, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function ShieldAlert({ size = 20, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
